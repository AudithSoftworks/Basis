...
elixir(function (mix) {
    ...
    var jsAliases = {
        ...
        'fine_uploader': ['public/bower_components/fine-uploader/_dist/5.5.0/fine-uploader/fine-uploader.js'],
    ...
    var cssAliases = {
        ...
        'fine_uploader': ['public/bower_components/fine-uploader/_dist/5.5.0/fine-uploader/fine-uploader-gallery.css'],
        'humane_js': [
